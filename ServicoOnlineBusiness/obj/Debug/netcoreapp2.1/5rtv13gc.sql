...
CREATE TABLE [db].[Servico] (
    ...
    [tipoServicoDominioId] int NULL,
    [Status] nvarchar(2) NULL DEFAULT N'AT',
    CONSTRAINT [PK_Servico] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_Servico_TipoServico_tipoServicoDominioId] FOREIGN KEY ([tipoServicoDominioId]) REFERENCES [db].[TipoServico] ([Id]) ON DELETE NO ACTION
);
...
VALUES (N'20180703120534_InitialCreate', N'2.1.1-rtm-30846');
